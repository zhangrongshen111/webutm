...
<head lang="en">
    ...
    <link rel="stylesheet" href="/css/flightPlan.css">
...
<div id="menuList">
    <ul class="topMenu">
        ...
        <li class="topItem">
            ...
            <ul class="downMenu">
                <li class="downItem"><a href="login.jsp">我的余额</a></li>
                <li><a href="login.jsp">我的余额</a></li>
                <li><a href="login.jsp">我的余额</a></li>
                <li><a href="login.jsp">我的余额</a></li>
            </ul>
                            ...
                            <div class="table-responsive box-default form-inline no-footer" >
                                        ...
                                        <div class="col-xs-6">
                                            <div class="datatables_length" aria-controls="datatable1" calss="form-control input-sm">
                                                <label class="search-date ">
                                                    <li><input type="datetime-local" class="form-control input-sm form-inline">&nbsp;&nbsp;开始时间</li>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="datatables_length" aria-controls="datatable1" calss="form-control input-sm">
                                                <label class="search-date">
                                                    <li><input type="datetime-local" class="form-control input-sm">&nbsp;&nbsp;截止时间&nbsp;&nbsp;<button type="submit" name="search" id="search-btn2" class="btn btn-flat btn-sm">查询</button></li>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody class="tbody-white">
                                        <c:forEach items="${fpList}" var="list">
